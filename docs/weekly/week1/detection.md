...
<script src="/js/test-script.js" defer></script>
...
<div class="test-card">
  <div class="test-score"><span>📊 基础分</span><span id="baseScore">0</span><span> / <span id="baseMax">0</span></span></div>
  <div class="test-score"><span>⭐ 含附加题</span><span id="totalScore">0</span><span> / <span id="totalMax">0</span></span></div>
