---
title: CC4链分析
description: Commons Collections 4 PriorityQueue + TransformingComparator 反序列化链，通过 InstantiateTransformer + TrAXFilter 调用 TemplatesImpl.newTransformer()
tags: [cc4, commons-collections4, deserialization, priorityqueue, instantiatetransformer, traxfilter]
status: 已完成
    ...
    TransformingComparator.compare()
        ...
        InstantiateTransformer.transform()
            ...
            TrAXFilter构造函数
                ...
                |
                TemplatesImp.defineTransletClasses()
                    |
...
``` 
![](java-deserialization(ing)/2026-05-25-14-17-02.png)